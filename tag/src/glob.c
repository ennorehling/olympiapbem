...
int v_look(struct command *), v_stack(struct command *), v_unstack(struct command *), v_promote(struct command *), v_die(struct command *);
int v_explore(struct command *), d_explore(struct command *), v_name(struct command *), v_banner(struct command *), v_notab(struct command *);
int v_move(struct command *), d_move(struct command *), v_sail(struct command *), d_sail(struct command *), i_sail(struct command *);
int v_give(struct command *), v_pay(struct command *), v_repair(struct command *), d_repair(struct command *), i_repair(struct command *), v_claim(struct command *);
int v_swear(struct command *), v_form(struct command *), d_form(struct command *), v_use(struct command *), d_use(struct command *), i_use(struct command *);
int v_teach(struct command *);
int v_study(struct command *), d_study(struct command *), v_format(struct command *);
#if 0
int v_acquire(struct command *);
#endif
int v_wait(struct command *), d_wait(struct command *), i_wait(struct command *), v_flag(struct command *), v_discard(struct command *), v_guard(struct command *);
int v_recruit(struct command *), v_make(struct command *), d_make(struct command *), i_make(struct command *), v_pillage(struct command *), d_pillage(struct command *);
int v_attack(struct command *), v_behind(struct command *), v_bribe(struct command *), d_bribe(struct command *);
int v_buy(struct command *), v_sell(struct command *), v_execute(struct command *), v_tell(struct command *), v_surrender(struct command *);
int v_honor(struct command *), v_oath(struct command *), v_terrorize(struct command *), d_terrorize(struct command *), v_quit(struct command *);
int v_build(struct command *), d_build(struct command *), v_quarry(struct command *), v_fish(struct command *), v_emote(struct command *);
int v_post(struct command *), v_message(struct command *), v_rumor(struct command *), v_press(struct command *);
int v_collect(struct command *), d_collect(struct command *), i_collect(struct command *), v_raze(struct command *), d_raze(struct command *);
int v_wood(struct command *), v_yew(struct command *), v_catch(struct command *), v_mallorn(struct command *), v_stop(struct command *);
int v_raise(struct command *), d_raise(struct command *), v_rally(struct command *), d_rally(struct command *), v_reclaim(struct command *);
int v_incite(struct command *), v_forget(struct command *), v_garrison(struct command *);
...
int v_torture(struct command *), d_torture(struct command *), v_trance(struct command *), d_trance(struct command *);
int v_fee(struct command *), v_ferry(struct command *), v_split(struct command *);
...
int v_enter(struct command *), v_exit(struct command *), v_north(struct command *), v_south(struct command *), v_east(struct command *), v_west(struct command *);

int v_be(struct command *), v_listcmds(struct command *), v_poof(struct command *), v_see_all(struct command *), v_invent(struct command *);
int v_add_item(struct command *), v_sub_item(struct command *), v_dump(struct command *), v_makeloc(struct command *), v_seed(struct command *);
int v_lore(struct command *), v_know(struct command *), v_skills(struct command *), v_save(struct command *), v_postproc(struct command *);
int v_los(struct command *), v_kill(struct command *), v_take_pris(struct command *), v_ct(struct command *), v_fix(struct command *), v_fix2(struct command *);
