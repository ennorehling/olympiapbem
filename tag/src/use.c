...
int v_sail(struct command *), d_sail(struct command *),
i_sail(struct command *);
int v_brew(struct command *), d_brew_heal(struct command *),
d_brew_death(struct command *), d_brew_slave(struct command *),
d_brew_fiery(struct command *);
...
v_catch(struct command *);
int v_spy_inv(struct command *), d_spy_inv(struct command *),
v_spy_lord(struct command *), d_spy_lord(struct command *);
int v_spy_skills(struct command *), d_spy_skills(struct command *);
int v_adv_med(struct command *), d_adv_med(struct command *),
v_hinder_med(struct command *), d_hinder_med(struct command *);
...
int v_detect_gates(struct command *), d_detect_gates(struct command *),
v_jump_gate(struct command *), v_teleport(struct command *);
int v_reverse_jump(struct command *), v_reveal_key(struct command *),
d_reveal_key(struct command *);
int v_seal_gate(struct command *), d_seal_gate(struct command *),
v_unseal_gate(struct command *), d_unseal_gate(struct command *);
int v_notify_unseal(struct command *), d_notify_unseal(struct command *),
v_rem_seal(struct command *), d_rem_seal(struct command *);
int v_notify_jump(struct command *), d_notify_jump(struct command *),
v_meditate(struct command *), d_meditate(struct command *);
int v_heal(struct command *), d_heal(struct command *),
v_reveal_mage(struct command *), d_reveal_mage(struct command *),
v_appear_common(struct command *);
int v_view_aura(struct command *), d_view_aura(struct command *),
v_shroud_abil(struct command *), d_shroud_abil(struct command *);
int v_detect_abil(struct command *), d_detect_abil(struct command *),
v_detect_scry(struct command *), d_detect_scry(struct command *);
int v_scry_region(struct command *), d_scry_region(struct command *),
v_shroud_region(struct command *), d_shroud_region(struct command *);
int v_dispel_region(struct command *), d_dispel_region(struct command *),
v_dispel_abil(struct command *), d_dispel_abil(struct command *);
int v_proj_cast(struct command *), d_proj_cast(struct command *),
v_locate_char(struct command *), d_locate_char(struct command *);
int v_bar_loc(struct command *), d_bar_loc(struct command *),
v_unbar_loc(struct command *), d_unbar_loc(struct command *);
int v_forge_palantir(struct command *), d_forge_palantir(struct command *),
v_destroy_art(struct command *), d_destroy_art(struct command *);
int v_show_art_creat(struct command *), d_show_art_creat(struct command *),
v_show_art_reg(struct command *), d_show_art_reg(struct command *);
int v_save_proj(struct command *), d_save_proj(struct command *),
v_save_quick(struct command *), d_save_quick(struct command *);
int v_quick_cast(struct command *), d_quick_cast(struct command *),
v_rem_art_cloak(struct command *), d_rem_art_cloak(struct command *);
int v_write_spell(struct command *), d_write_spell(struct command *),
v_curse_noncreat(struct command *), d_curse_noncreat(struct command *);
int v_cloak_creat(struct command *), d_cloak_creat(struct command *),
v_cloak_reg(struct command *), d_cloak_reg(struct command *);
int v_forge_aura(struct command *), d_forge_aura(struct command *),
v_bribe(struct command *), d_bribe(struct command *);
int v_shipbuild(struct command *), v_summon_savage(struct command *),
v_keep_savage(struct command *), d_keep_savage(struct command *);
int v_improve_opium(struct command *), d_improve_opium(struct command *),
v_lead_to_gold(struct command *), d_lead_to_gold(struct command *);
int v_raise(struct command *), d_raise(struct command *),
v_rally(struct command *), d_rally(struct command *),
v_incite(struct command *), d_incite(struct command *);
int v_bird_spy(struct command *), d_bird_spy(struct command *),
v_eat_dead(struct command *), d_eat_dead(struct command *);
int v_raise_corpses(struct command *), v_undead_lord(struct command *),
d_undead_lord(struct command *);
int v_banish_undead(struct command *), d_banish_undead(struct command *),
v_keep_undead(struct command *), d_keep_undead(struct command *);
int v_aura_blast(struct command *), d_aura_blast(struct command *),
v_aura_reflect(struct command *), v_banish_corpses(struct command *),
d_banish_corpses(struct command *);
int v_summon_rain(struct command *), d_summon_rain(struct command *),
v_summon_wind(struct command *), d_summon_wind(struct command *);
int v_summon_fog(struct command *), d_summon_fog(struct command *),
v_dissipate(struct command *), d_dissipate(struct command *);
int v_direct_storm(struct command *), v_renew_storm(struct command *),
d_renew_storm(struct command *);
int v_lightning(struct command *), d_lightning(struct command *);
int v_seize_storm(struct command *), d_seize_storm(struct command *),
v_death_fog(struct command *), d_death_fog(struct command *);
int v_hide(struct command *), d_hide(struct command *),
v_sneak(struct command *), d_sneak(struct command *),
v_fierce_wind(struct command *), d_fierce_wind(struct command *);
...
v_reveal_vision(struct command *), d_reveal_vision(struct command *);
int v_create_dirt_golem(struct command *),
d_create_dirt_golem(struct command *);
int v_create_flesh_golem(struct command *),
d_create_flesh_golem(struct command *);
int v_create_iron_golem(struct command *),
d_create_iron_golem(struct command *);
int v_resurrect(struct command *), d_resurrect(struct command *),
v_prep_ritual(struct command *), d_prep_ritual(struct command *);
int v_last_rites(struct command *), d_last_rites(struct command *),
v_remove_bless(struct command *), d_remove_bless(struct command *);
int v_find_rich(struct command *), d_find_rich(struct command *),
v_torture(struct command *), d_torture(struct command *);
int v_fight_to_death(struct command *), v_breed(struct command *),
d_breed(struct command *), v_fish(struct command *);
int v_petty_thief(struct command *), d_petty_thief(struct command *),
i_petty_thief(struct command *), v_persuade_oath(struct command *),
d_persuade_oath(struct command *);
...
v_tap_health(struct command *), d_tap_health(struct command *);
#if 0
...
int v_bless_follower(struct command *), v_proselytise(struct command *),
v_create_holy_symbol(struct command *);
...
int v_gather_holy_plant(struct command *),
d_gather_holy_plant(struct command *);

int v_find_mountain_trail(struct command *),
v_obscure_mountain_trail(struct command *);
...
int v_find_forest_trail(struct command *),
d_obscure_forest_trail(struct command *),
v_obscure_forest_trail(struct command *);
int d_improve_logging(struct command *), v_improve_logging(struct command *),
d_find_hidden_features(struct command *);
int v_find_hidden_features(struct command *),
v_improve_fort(struct command *), d_improve_fort(struct command *);
int v_recruit_elves(struct command *), d_recruit_elves(struct command *);

int d_improve_quarrying(struct command *),
v_improve_quarrying(struct command *);
int d_improve_smithing(struct command *),
v_improve_smithing(struct command *);
...
int v_improve_charisma(struct command *),
d_improve_charisma(struct command *);
...
int d_conceal_location(struct command *),
v_conceal_location(struct command *);
...
v_hide_item(struct command *c), d_hide_item(struct command *c);
...
/* Mining */
int v_mine_iron(struct command *), d_mine_iron(struct command *),
v_mine_gold(struct command *), d_mine_gold(struct command *);
int v_mine_mithril(struct command *), d_mine_mithril(struct command *),
v_quarry(struct command *);
int v_mine_gate_crystal(struct command *),
d_mine_gate_crystal(struct command *);
int d_add_wooden_shoring(struct command *),
v_add_wooden_shoring(struct command *);
int d_add_iron_shoring(struct command *),
v_add_iron_shoring(struct command *);
...
int v_use_cs(struct command *);
int v_implicit(struct command *);
 ...
 */
  ...
  {"c", sk_flesh_golem, v_create_flesh_golem, d_create_flesh_golem, NULL, 7,
   0},
  ...
  {"c", sk_mine_crystal, v_mine_gate_crystal, d_mine_gate_crystal, NULL, 7,
   0},
  ...
  {"c", sk_gather_holy_plant, v_gather_holy_plant, d_gather_holy_plant, NULL,
   10, 0},
  ...
  {"c", sk_improve_forestry, v_improve_logging, d_improve_logging, NULL, 7,
   0},
  ...
  {"c", sk_improve_quarry, v_improve_quarrying, d_improve_quarrying, NULL, 7,
   0},
  {"c", sk_improve_smithing, v_improve_smithing, d_improve_smithing, NULL, 7,
   0},
  ...
  {"c", sk_improve_charisma, v_improve_charisma, d_improve_charisma, NULL, 7,
   0},
  ...
  {"c", sk_strengthen_castle, v_strengthen_castle, d_strengthen_castle, NULL,
   5, 0},
  {"c", sk_moat_castle, v_moat_castle, d_moat_castle, NULL, 5, 1},
  {"c", sk_widen_entrance, v_widen_entrance, d_widen_entrance, NULL, 5, 0},

  {"c", sk_wooden_shoring, v_add_wooden_shoring, d_add_wooden_shoring, NULL,
   5, 0},
  ...
  {"c", sk_gather_holy_plant_b, v_gather_holy_plant, d_gather_holy_plant,
   NULL, 10, 0},
  ...
  {"c", sk_dedicate_temple_b, v_dedicate_temple, d_dedicate_temple, NULL, 7,
   0},
...
v_use_cs(struct command *c)
{
  ...
  for (i = 1; i <= num; i++) {
    ...
    if (arg == 1) {
      wout(c->who,
           "You cannot use combat spells during the first round of combat.");
    }
    else if (arg > 10) {
 ...
 */
  ...
  if (sk != sk_breed_beasts && (!c->poll || c->wait == 0))
  ...
  if (ret) {
    ...
    if (religion_skill(sk)) {
      ...
      if (!use_piety(c->who, skill_piety(sk))) {
        wout(c->who,
             "That was exceedingly strange.  Mention this to the DM, please.");
      }
...
forget_skill(int who, int skill)
{
  ...
  if (skill_school(skill) == skill) {
    loop_skill(i) {
      if (i != skill && skill_school(i) == skill && p_skill_ent(who, i))
        forget_skill(who, i);
    }
    next_skill;
  }
...
has_subskill(int who, int subskill)
{
  ...
  loop_inv(who, i) {
    ...
    if (a) {
      if (a->type == ART_SKILL && subkind(a->param1) == subskill)
        return a->param1;
    };
  }
  next_inv;
...
has_skill(int who, int skill)
{
  ...
  if (p == NULL || p->know != SKILL_know) {
    int a = has_artifact(who, ART_SKILL, skill, 0, 0);
    if (a)
      return exp_teacher;
    return 0;
  };
...
list_skill_sup(int who, struct skill_ent *e)
{
  ...
  if (skill_no_exp(e->skill) || skill_school(e->skill) == e->skill)
    ...
    wiout(who, CHAR_FIELD + 2, "%*s  %s, %s %s",
          ...
          exp_s(exp_level(e->experience)), practice_s(e));
}
...
list_skill_sup(int who, struct skill_ent *e, char *prefix)
{
   ...
   */
  if (kind(who) == T_char &&
      combat_skill(e->skill) && get_effect(who, ef_cs, e->skill, 0)) {
    char *rounds = "";
    ...
    for (i = 0; i < ilist_len(ef); i++)
      if (ef[i]->type == ef_cs && ef[i]->subtype == e->skill) {
...
fractional_skill_qualifier(struct skill_ent *p)
{
  ...
  if (frac == 0)
    return sout("%d/%d %s", p->days_studied / TOUGH_NUM,
                learn_time(p->skill), explanation);

  return sout("%d.%d/%d %s", p->days_studied / TOUGH_NUM,
              frac * 100 / TOUGH_NUM, learn_time(p->skill), explanation);
}
...
list_partial_skills(int who, int num, char *prefix)
{
  ...
  for (i = 0; i < ilist_len(l); i++) {
    ...
    wiout(who, 6, "%s%s, %s",
          prefix, box_name(l[i]->skill), fractional_skill_qualifier(l[i]));
  }
...
being_taught(int who, int sk, int *item, int *teach_bonus)
{
  ...
  *item = 0;
  ...
  if (teachable_place(where, sk)) {
    ...
    loop_stack(where, i) {
      c = rp_command(i);
      if (c && cmd_tbl[c->cmd].start == v_teach && c->state == RUN) {
        teacher = i;
        break;
      };
    }
...

  {
    ...
    loop_inv(who, e) {
      ...
      if (p && ilist_lookup(p->may_study, sk) >= 0 &&
          p->orb_use_count > 0 && subkind(e->item) == sub_book) {
        ret_specific = e->item;
        break;
      }
  ...
  if ((sk == sk_combat ||
       ...
       sk == sk_forestry ||
       sk == sk_ranger ||
       sk == sk_mining || sk == sk_trading) && player_js(player(who))) {
...
begin_study(struct command *c, int sk)
{
  ...
  loop_char_skill(c->who, e) {
    if (e->skill == sk_basic_religion || e->skill == sk_adv_sorcery)
      continue;
    if (!rp_skill(e->skill)->required_skill)
      num_base_skills++;
  }
  next_char_skill;
  ...
  if (!is_npc(c->who) && np_req > 0) {
    wout(c->who, "It will require %s noble point%s to complete "
         "the study of %s.",
         cap(nice_num(np_req)), add_s(np_req), box_code(sk));
  };
...
check_study(struct command *c, int requires_instruction)
{
  ...
  if (nation(c->who) &&
      (ilist_lookup(rp_nation(nation(c->who))->proscribed_skills, sk) != -1 ||
       ilist_lookup(rp_nation(nation(c->who))->proscribed_skills,
                    parent) != -1)) {
  ...
  if (religion_skill(sk) &&
    ...
    wout(c->who,
         "Because you're a member of the %s Guild, the %s will not accept you.",
         box_name(guild_member(c->who)), box_name(sk));
    return FALSE;
  };
   ...
   *
   */
  if (religion_skill(sk) && is_wizard(c->who)) {
...
learn_skill(int who, int sk)
{
  ...
  if (nation(who) &&
      (ilist_lookup(rp_nation(nation(who))->proscribed_skills, sk) != -1 ||
       ilist_lookup(rp_nation(nation(who))->proscribed_skills,
                    skill_school(sk)) != -1)) {
    return FALSE;
  };
...
d_study(struct command *c)
{
  ...
  if ((teachable || category) && bt && item && (ip = rp_item_magic(item))) {
  ...
  if (p->days_studied + religion_bonus + building_bonus + artifact_bonus
    ...
    if (religion_bonus < 0) {
      wout(c->who,
           "This topic offends your values and is difficult to learn.");
    };
...
v_practice(struct command *c)
{
  ...
  if (practice_progressive(sk)) {
    c->wait +=
      (p_skill_ent(c->who, sk)->experience) / practice_progressive(sk);
  };
...
v_research(struct command *c)
{
  ...
  if (has_skill(c->who, sk)) {
    wout(c->who, "%s already knows %s", box_name(c->who), box_name(sk));
    return FALSE;
  }
...
d_research(struct command *c)
{
  ...
  wout(c->who, "Research successful for %s", box_name(sk));
...
v_teach(struct command *c)
{
  ...
  if (!teachable_place(where, sk)) {
    wout(c->who,
         "Teaching must be performed in a tower or (appropriate) guild.");
    return FALSE;
  }
