...
int v_brew(struct command *), d_brew_heal(struct command *), d_brew_death(struct command *), d_brew_slave(struct command *), d_brew_fiery(struct command *);
...
int v_adv_med(struct command *), d_adv_med(struct command *), v_hinder_med(struct command *), d_hinder_med(struct command *);
...
int v_forge_palantir(struct command *), d_forge_palantir(struct command *), v_destroy_art(struct command *), d_destroy_art(struct command *);
int v_show_art_creat(struct command *), d_show_art_creat(struct command *), v_show_art_reg(struct command *), d_show_art_reg(struct command *);
int v_save_proj(struct command *), d_save_proj(struct command *), v_save_quick(struct command *), d_save_quick(struct command *);
int v_quick_cast(struct command *), d_quick_cast(struct command *), v_rem_art_cloak(struct command *), d_rem_art_cloak(struct command *);
int v_write_spell(struct command *), d_write_spell(struct command *), v_curse_noncreat(struct command *), d_curse_noncreat(struct command *);
int v_cloak_creat(struct command *), d_cloak_creat(struct command *), v_cloak_reg(struct command *), d_cloak_reg(struct command *);
int v_forge_aura(struct command *), d_forge_aura(struct command *), v_bribe(struct command *), d_bribe(struct command *);
int v_shipbuild(struct command *), v_summon_savage(struct command *), v_keep_savage(struct command *), d_keep_savage(struct command *);
int v_improve_opium(struct command *), d_improve_opium(struct command *), v_lead_to_gold(struct command *), d_lead_to_gold(struct command *);
int v_raise(struct command *), d_raise(struct command *), v_rally(struct command *), d_rally(struct command *), v_incite(struct command *), d_incite(struct command *);
int v_bird_spy(struct command *), d_bird_spy(struct command *), v_eat_dead(struct command *), d_eat_dead(struct command *);
...
int v_aura_blast(struct command *), d_aura_blast(struct command *), v_aura_reflect(struct command *), v_banish_corpses(struct command *), d_banish_corpses(struct command *);
int v_summon_rain(struct command *), d_summon_rain(struct command *), v_summon_wind(struct command *), d_summon_wind(struct command *);
int v_summon_fog(struct command *), d_summon_fog(struct command *), v_dissipate(struct command *), d_dissipate(struct command *);
...
int v_seize_storm(struct command *), d_seize_storm(struct command *), v_death_fog(struct command *), d_death_fog(struct command *);
int v_hide(struct command *), d_hide(struct command *), v_sneak(struct command *), d_sneak(struct command *), v_fierce_wind(struct command *), d_fierce_wind(struct command *);
...
int v_resurrect(struct command *), d_resurrect(struct command *), v_prep_ritual(struct command *), d_prep_ritual(struct command *);
int v_last_rites(struct command *), d_last_rites(struct command *), v_remove_bless(struct command *), d_remove_bless(struct command *);
int v_find_rich(struct command *), d_find_rich(struct command *), v_torture(struct command *), d_torture(struct command *);
int v_fight_to_death(struct command *), v_breed(struct command *), d_breed(struct command *), v_fish(struct command *);
int v_petty_thief(struct command *), d_petty_thief(struct command *), i_petty_thief(struct command *),
  v_persuade_oath(struct command *), d_persuade_oath(struct command *);
int v_forge_art_x(struct command *), d_forge_art_x(struct command *), v_trance(struct command *), d_trance(struct command *);
