...
bottom_out(int pl, int who, int unit, char *s)
{
  ...
  switch (bits) {
  case 0:
    fprintf(fp, "%d:%d::%d::%s\n", who, style_html, indent, s);
    break;

  case 1:
    fprintf(fp, "%d:%d::%d:%d:%s\n", who, style_html, indent, sysclock.day,
            s);
    break;

  case 2:
    fprintf(fp, "%d:%d::%d/%d::%s\n", who, style_html, indent, second_indent,
            s);
    break;

  case 3:
    fprintf(fp, "%d:%d::%d/%d:%d:%s\n", who, style_html, indent,
            second_indent, sysclock.day, s);
    break;

  case 4:
    fprintf(fp, "%d:%d:%s:%d::%s\n",
            who, style_html, box_code_less(unit), indent, s);
    break;

  case 5:
    fprintf(fp, "%d:%d:%s:%d:%d:%s\n",
            who, style_html, box_code_less(unit), indent, sysclock.day, s);
    break;

  case 6:
    fprintf(fp, "%d:%d:%s:%d/%d::%s\n",
            who, style_html, box_code_less(unit), indent, second_indent, s);
    break;

  case 7:
    fprintf(fp, "%d:%d:%s:%d/%d:%d:%s\n",
            who, style_html, box_code_less(unit), indent,
            second_indent, sysclock.day, s);
    break;
...
html(who, format, a1, a2, a3, a4, a5, a6, a7, a8, a9, aa, ab, ac)
     int who;
     char *format;
     long a1, a2, a3, a4, a5, a6, a7, a8, a9, aa, ab, ac;
{
...
#if 0
    if (valid_box(player(who))) {
      out_path = MASTER;
      out_alt_who = OUT_HTML_INDEX;

      html(player(who), "<a href=\"#%s\">%s", before, before);
